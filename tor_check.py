...
#49500
for prop in range(19102,19103,1): 
    #try:
    ...
    if isinstance(images_all,dict)==True and images_all['@Category'] in ['1','2','3','4','5','6','7','8','9','13','23']:
        ...
        for cat_rooms in categories_rooms:
            cat_rooms_num=0
            image_cat = [d for d in images_all if d['@Category'] in cat_rooms]
            print("*****************")
            print(image_cat)
            print("*****************")
            for i in range(len(image_cat)):
                if images_all[i]['@Category'] == cat_rooms:
                    ...
                    try:
                        ...
                        conditions = [
                        (images_all[i]['@Category']=='1'),
                        (images_all[i]['@Category']=='2'),
                        (images_all[i]['@Category']=='3'),
                        (images_all[i]['@Category']=='4'),
                        (images_all[i]['@Category']=='5'),
                        (images_all[i]['@Category']=='6'),
                        (images_all[i]['@Category']=='7'),
                        (images_all[i]['@Category']=='8'),
                        (images_all[i]['@Category']=='9'),
                        (images_all[i]['@Category']=='13'),
                        (images_all[i]['@Category']=='23')
                        ]
                    ...
                    if (int(height)>=800 and int(width)>=1000) or url_last7=="XXL.jpg":
                        ...
                        if images_all[i]['@Category'] in ['6','7']:
                            gr=True
                            guest_room_num=guest_room_num+1
                        else:
                            gr=False
                        guest_rooms.append(gr)
                        cat_rooms_num=cat_rooms_num+1
                if cat_rooms_num>=3:
                    break 
            if len(urls)==0:
                try:
    ...
    wb = load_workbook('Travelport_all_data.xlsx')
    ws = wb['Statistics']
    ...
    wb.save('Travelport_all_data.xlsx')
